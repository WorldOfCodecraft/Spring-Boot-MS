package com.framework.microservices.core.review;
...
import com.framework.microservices.core.review.persistence.ReviewEntity;
import com.framework.microservices.core.review.persistence.ReviewRepository;

/**
 * MNote, p151
 * By default, Spring Boot configures the tests to roll back updates to the SQL database
 * to minimize the risk of negative side effects on other tests.
 *
 * In our case, this behavior will cause some of the tests to fail.
